...
urlpatterns = [
    ...
    path('dashboard/department/<uuid:dept_id>/', department_analytics, name='dashboard-department-analytics'),
    ...
    path('admin/notifications/send/', admin_send_notification, name='admin-notification-send'),
    path('admin/notifications/templates/', admin_notification_templates, name='admin-notification-templates'),
    path('admin/notifications/stats/', admin_delivery_stats, name='admin-delivery-stats'),
    ...
    path('platform/tenants/<uuid:tenant_id>/config/', tenant_config, name='platform-tenant-config'),
    path('platform/tenants/<uuid:tenant_id>/usage/', tenant_usage, name='platform-tenant-usage'),
    path('platform/tenants/<uuid:tenant_id>/invoices/', tenant_invoices, name='platform-tenant-invoices'),

    # Platform — Subscription plans
    path('platform/subscriptions/plans/', subscription_plans_list, name='platform-subscription-plans'),
    path('platform/subscriptions/plans/<uuid:plan_id>/', subscription_plan_detail, name='platform-subscription-plan-detail'),
    path('platform/subscriptions/', tenant_subscriptions_list, name='platform-subscriptions'),

    # Platform — Feature flags
    path('platform/feature-flags/', feature_flags_list, name='platform-feature-flags'),
    path('platform/feature-flags/<str:key>/', feature_flag_detail, name='platform-feature-flag-detail'),
    path('platform/feature-flags/<str:key>/tenants/', feature_flag_tenants, name='platform-feature-flag-tenants'),
    path('platform/feature-flags/<str:key>/tenants/<uuid:tenant_id>/', feature_flag_tenant_override, name='platform-feature-flag-tenant-override'),

    # Platform — Health history & Billing events
    path('platform/health/history/', health_history, name='platform-health-history'),
    path('platform/billing/events/', billing_events_list, name='platform-billing-events'),
    ...
    path('audit/events/<uuid:event_id>/', audit_event_detail, name='audit-event-detail'),
    path('audit/security-alerts/', audit_security_alerts, name='audit-security-alerts'),
    path('audit/security-alerts/<uuid:alert_id>/', audit_security_alert_update, name='audit-security-alert-update'),
    path('audit/compliance/', audit_compliance_records, name='audit-compliance-records'),
    path('audit/compliance/report/', audit_compliance_report, name='audit-compliance-report'),

    # ── Audit Logging & Compliance (platform owner) ────────────────────
    path('platform/audit/events/', platform_audit_events, name='platform-audit-events'),
    path('platform/audit/events/verify/', platform_audit_verify_chain, name='platform-audit-verify'),
    path('platform/audit/events/export/', platform_audit_export, name='platform-audit-export'),
    path('platform/audit/events/stats/', platform_audit_stats, name='platform-audit-stats'),
    path('platform/audit/events/<uuid:event_id>/', platform_audit_event_detail, name='platform-audit-event-detail'),
    path('platform/audit/security-alerts/', platform_security_alerts, name='platform-security-alerts'),
    path('platform/audit/retention-policies/', platform_retention_policies, name='platform-retention-policies'),
    path('platform/audit/retention-policies/<uuid:policy_id>/', platform_retention_policy_update, name='platform-retention-policy-update'),
    path('platform/audit/data-deletion-requests/', platform_data_deletion_requests, name='platform-data-deletion-requests'),
    path('platform/audit/data-deletion-requests/<uuid:request_id>/', platform_data_deletion_update, name='platform-data-deletion-update'),

    # ── Analytics & Reporting ─────────────────────────────────────────────
    path('analytics/tenant/', tenant_analytics, name='analytics-tenant'),
    path('analytics/alerts/rules/', alert_rules_list, name='analytics-alert-rules'),
    path('analytics/alerts/rules/<uuid:rule_id>/', alert_rule_detail, name='analytics-alert-rule-detail'),
    path('analytics/alerts/', metric_alerts_list, name='analytics-alerts'),
    path('analytics/alerts/<uuid:alert_id>/<str:action>/', metric_alert_action, name='analytics-alert-action'),

    # Platform analytics (enhanced)
    path('platform/analytics/enhanced/', platform_analytics_enhanced, name='platform-analytics-enhanced'),
    path('platform/analytics/quality/', platform_quality_analytics, name='platform-analytics-quality'),
    path('platform/analytics/forecast/', platform_forecast, name='platform-analytics-forecast'),
    path('platform/analytics/alerts/rules/', platform_alert_rules, name='platform-analytics-alert-rules'),
    path('platform/analytics/alerts/', platform_metric_alerts, name='platform-analytics-alerts'),
